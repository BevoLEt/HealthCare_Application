        ...
        btn_to_tutorial.setOnClickListener(
                new View.OnClickListener(){
                    public void onClick(View v){
                        ...
                        Intent intentTotuto=new Intent(PopupContentActivity.this, TutorialActivity.class);
        ...
        btn_to_sol.setOnClickListener(
                new View.OnClickListener(){
                    public void onClick(View v){
                        ...
                        Intent intentTosol=new Intent(PopupContentActivity.this, SolutionActivity.class);
